...
ONP.lm = lm(formula=shares ~ num_videos + num_imgs + n_tokens_content + rate_positive_words+rate_negative_words+is_weekend+factor(weekday_is_saturday), data = ONP_Trimmed)
summary(ONP.lm)
str(ONP_Trimmed)
```
